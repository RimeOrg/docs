---
title: "RESDB schema"
description: "Local SQLite database schema reference for RES"
---

RESDB is the local SQLite database that RES uses to store event data for high-speed querying. It uses WAL (Write-Ahead Logging) mode for concurrent read/write operations and maintains tables for zone dwell events and visitor entries.
